package com.kill3rtaco.api.bukkit.util.serialization;
...
/**
 * A class to help with the serialization of PotionEffects. The serialization
 * technique is similar to that of serializing enchantments. The process can be
 * as explained as such: <br/>
 * <br/>
 * 
 * <pre>
...
public class PotionEffectSerialization {
	...
	/**
	 * Serialize a Collection of PotionEffects into a string that follows the
	 * regex
	 * 
	 * <pre>
	 * ([0-9]+:[0-9]+:[0-9]+;)+
	 ...
	 * 
	 * @param effects
	 *            The PotionEffects to serialize
	 ...
	 *            The potion effect code to decode from
	 ...
	 * 
	 * @param code
	 *            The PotionEffects to add
	 * @param entity
	 *            The entity to add the PotionEffects
	 */
	...
	/**
	 * Remove any current PotionEffects from a LivingEntity then add the given
	 * effects
	 * 
	 * @param code
	 *            The PotionEffects to add
	 * @param entity
	 *            The entity to set the PotionEffects
	 */
